...
Train local planner using CPO so that a vehicle can follow a straight
trajectory while never driving away from the line.
...
def main():
    ...
    if args.network is not None:
        ...
        use_pretrained = True
        raise NotImplementedError('Fine-tuning does not work at the moment')
    else:
